...
func _process(delta):
	...
	$preocupacion_esceptico.text = "Preocupacion del Alexei: " + str(GameManager.preocupacion_esceptico)

	$vida_esceptico.text = "Vida del Alexei: " + str(GameManager.vida_esceptico)
